...
function! s:ExtensionLoaderConstructor(name)
  ...
  let extensionLoaderObj.start = function('<SNR>' . s:SID() . '_ExtensionLoader_start')
  let extensionLoaderObj.stop = function('<SNR>' . s:SID() . '_ExtensionLoader_stop')
  return extensionLoaderObj
endfunction

function! s:ExtensionLoader_start() dict
...
function! s:ExtensionLoader_stop() dict
  execute ":augroup portkey_extension_" . self.name . "_group"
  execute ":autocmd!"
  execute ":augroup END"
endfunction
...
function! s:EmberPluginConstructor()
  let emberPluginObj = {}
  let emberPluginObj.start = function('<SNR>' . s:SID() . '_EmberPlugin_start')
  return emberPluginObj
endfunction

function! s:EmberPlugin_start() dict
